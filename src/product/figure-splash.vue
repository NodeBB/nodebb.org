...
export default {
    data() {
        return {
            icons: [{
                    name: "Node.js",
                    img: require("./img/icon-nodejs.svg")
                },
                {
                    name: "MongoDB",
                    img: require("./img/icon-mongodb.svg")
                },
                {
                    name: "Redis",
                    img: require("./img/icon-redis.svg")
                },
                {
                    name: "Websockets",
                    img: require("./img/icon-websocket.svg")
                }
...
figure.splash-figure-container.splash-figure-main {
    ...
    .splash-figure.code {
        ...
        @keyframes themeTransform {
            ...
            to {
                transform: scale(1) perspective(500px) rotateX(1deg) rotateY(-2deg) rotateZ(0deg) translateZ(-35px);
            }
        }
        ...
        @keyframes tabletTransform {
            ...
            to {
                transform: perspective(1040px) rotate(-2deg) rotateX(-2deg) rotateY(11deg) translateZ(20px) scale(1);
            }
        }
    }
    ...
    .splash-figure.dashboard .stage {
        ...
        .mobile-device {
            ...
            &:hover {
                ...
                transform: rotate(0deg) rotateX(0deg) rotateY(0deg) translateX(2em) translateZ(60px) scale(1.2);
            }
        }
        ...
        @keyframes mainTransform {
            ...
            to {
                transform: scale(1) perspective(500px) rotateX(1deg) rotateY(-2deg) rotateZ(0deg) translateZ(-45px);
            }
        }
