  ...
  .dashboard {
    ...
    .screenshot {
      ...
      &.card-dashboard {
        ...
        right: auto;
        z-index: 0;
        transform: scale(1) perspective(1040px) rotateY(-6deg) rotateX(3deg)
          rotate(2deg) translateZ(-50px);
      ...
      &.magnify {
        ...
        box-shadow: 0px 0px 3px rgba(50, 50, 93, 0.2),
          0px 14px 32px rgba(50, 50, 93, 0.1);
        overflow: hidden;
        border-radius: 50%;
        img {
          height: 150px;
          ...
          box-shadow: 0px 50px 100px rgba(50, 50, 93, 0.13),
            0px 15px 35px rgba(50, 50, 93, 0.11),
