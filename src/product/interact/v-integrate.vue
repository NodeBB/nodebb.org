      ...
      features: [
        {
          ...
          text: `Be in control with access to trending content, user activity, and other forum metrics.`,
          // figure: () => import("./figure-.vue"),
          link: { path: "/pricing", text: "Learn more" }
        },
        {
          title: "Customise with HTML, CSS, and JavaScript",
          text: `Tweak your forum's design to your heart's content. Don't worry - if something goes wrong, reverting is a snap. You can even paste scripts from third party vendors such as Google Analytics.`,
          // figure: () => import("./figure-.vue"),
          link: { path: "/pricing", text: "Learn more" }
        },
        {
          title: "Drag-and-drop widgets",
          text: `Add new functionality to your forum via the widgets system. You can add new content via an HTML widget or from over a dozen other widgets by dragging and dropping it onto a widget area on your forum.`,
          // figure: () => import("./figure-.vue"),
          link: { path: "/pricing", text: "Learn more" }
        },
        {
          title: "Access control",
          text: `Grant privileges to individual users or groups, allowing you to create read-only categories or hide them altogether. Give forum members elevated roles such as "Moderator" to allow them to help police your community.`,
          // figure: () => import("./figure-.vue"),
          link: { path: "/pricing", text: "Learn more" }
        }
      ]
