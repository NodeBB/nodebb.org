<template>
  <figure ref="wrapper" class="splash-figure-container splash-figure-home" @click="nextSlide()">
    <div class="figure-wrap">
      <div v-if="activeSlide.id == 'dashboard'" class="splash-figure dashboard">
        <div class="stage-icons-wrap">
          <!-- <div class="stage-icons">
            <img src="./img/plugin-jobs.svg" alt class="flying-icon icon-1" />
            <img src="./img/plugin-email.svg" alt class="flying-icon icon-2" />
            <img src="./img/plugin-ssr.svg" alt class="flying-icon icon-3" />
            <img src="./img/plugin-blog.svg" alt class="flying-icon icon-4" />
            <img src="./img/plugin-notify.svg" alt class="flying-icon icon-5" />
            <img
        ...
        <div class="stage">
          <img src="../product/img/desktop-view.svg" alt class="main" />
          <img src="../product/img/category-topic-view-clip-b.svg" alt class="main-clip" />

          <img src="../product/img/tablet-view.svg" alt class="tablet-device" />
          <img src="../product/img/tablet-composer-view.svg" alt class="tablet-device-clip" />

          <img src="../product/img/mobile-view.svg" alt class="mobile-device" />
          <img src="../product/img/category-topic-view-clip-a.svg" alt class="mobile-device-clip" />
        </div>
      </div>
    </div>
...
<style lang="less">
figure.splash-figure-container.splash-figure-home {
  position: relative;
    ...
    @keyframes tabletTransformHome {
      ...
      to {
        transform: scale(0.8) perspective(1200px) rotateX(0deg) rotateY(0deg)
          translateZ(-134px) translateY(-16rem) rotate(-12deg)
          translateX(-128px);
      }
    }
      ...
      @keyframes tabletTransformHome {
        ...
        to {
          transform: scale(0.6) perspective(1200px) rotateX(0deg) rotateY(0deg)
            translateZ(-134px) translateY(-548px) rotate(-12deg)
            translateX(-128px);
        }
      }
    }
