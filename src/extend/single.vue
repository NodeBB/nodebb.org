          ...
          <div class="content">
            ...
            <div class="text">
              <div class="title-wrap">
                ...
                <div class="actions">
                  <factor-link btn="primary" @click="scrollTo(`#install`)">Add to your forum &darr;</factor-link>
                  <factor-link
                    v-if="post.demo"
                    btn="default"
                    :path="post.demo"
            ...
            <div class="info" :class="block">
              <div v-if="block == 'install'" class="install-extension">
                <div class="title-header">
                  <div class="sub-title">Add this plugin to your NodeBB community forum:</div>
                </div>
...
export default {
  ...
  created() {
    ...
    this.headerScreenshots = allScreenshots.filter((_: string) =>
      _.includes("tall")
    );
  ...
  methods: {
    ...
    screenshotStyle(index: number) {
      const style = {
        transform: `translate(${index * 15}%, ${index}%) scale(${1 -
          index * 0.1})`,
        zIndex: 50 - index
      };
