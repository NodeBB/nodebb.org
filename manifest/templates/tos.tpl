				...
				<div class="bg-splash dk splash-x">
					<div class="container">
						<div class="">
							...
							<h3 class="text-white font-thin text-center">NodeBB Terms of Service</h3>
						</div>
					</div>
				</div>
				<div class="bg-white">
						...
						<section class="legal m-b-xl m-t-xl">
							...
							<ol>
								<li>
									...
									<span>
									If you operate a forum, comment on a forum, post material to the Website, post links on the Website, or otherwise make (or allow any third party to make) material available by means of the Website (any such material, "Content"), You are entirely responsible for the content of, and any harm resulting from, that Content. That is the case regardless of whether the Content in question constitutes text, graphics, an audio file, or computer software. By making Content available, you represent and warrant that:
									</span>
								</li>
							</ol>
							<ul>
							...
							<ol>
								<li>
									...
									<span>
									<a href="dmca">
									Forums Digital Millennium Copyright Act (”DMCA”) Policy
									</a>.
									</span>
									<span>
							...
							<ol>
								<li>
									...
									<span>
									You may terminate your account on Nodebb.org at any time by contacting sales@nodebb.org. There are no refunds for any fees paid. YOU ARE SOLELY RESPONSIBLE FOR TERMINATING YOUR ACCOUNT AND THIS AGREEMENT. WE ARE NOT RESPONSIBLE FOR YOUR FAILURE TO PROPERLY TERMINATE YOUR ACCOUNT AND THIS AGREEMENT OR FOR ANY CREDIT CARD OR OTHER CHARGES OR FEES YOU INCUR AS A RESULT OF YOUR FAILURE TO PROPERLY TERMINATE YOUR ACCOUNT AND THIS AGREEMENT.
									</span>
								</li>
