<section class="content subpage container clearfix integrations">
	<div class="clearfix">
		...
		<div class="text-center" style="font-size: 30px;">Hold tight, this section is coming soon!</div><br /><br /><br />
	...
	<div class="clearfix mobile-responsive text-center sso">
		<h1>Single Sign-On Providers</h1>
		<h2>Allow your users to register with the SSO provider of their choice.</h2>
