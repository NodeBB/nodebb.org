<section class="hero">
	<div class="hero-signup">
		...
		<a title="Sign-up to create your NodeBB forum" href="//manage.nodebb.org/register" class="desktop-only" data-outboundTrack="//manage.nodebb.org/register">Start Free Trial</a>
	</div>
	...
	<div class="hero-signup tablet-only">
		<a title="Sign-up to create your NodeBB forum" href="//manage.nodebb.org/register" class="tablet-only" data-outboundTrack="//manage.nodebb.org/register">Start Free Trial</a>
	</div>
</section>
	...
	<div class="clearfix" id="testimonial">
		<div class="clearfix testimonial">
			...
			<div class="pull-right w75">
				...
				<p class="attribution">
					&mdash; <img class="mobile-avatar" src="/assets/images/testimonials/people/attis.jpg"> Artur Matczak, Software Engineer, <a target="_blank" href="https://forums.opera.com/">Opera Forums</a>
				</p>
			</div>
		</div>
