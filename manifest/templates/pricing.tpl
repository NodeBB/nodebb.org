	...
	<div class="pricing content">
		<div class="container clearfix relative">
			<div class="mobile-responsive text-center">
				...
				<h2>Need help figuring out the right plan for your business? <a class="pointer" onclick="javascript:$zopim.livechat.window.show();">Contact us</a>.</h2>
			</div><br /><br />
			...
			<div class="table">
				...
				<!-- <ul class="fourth">
					...
					<li class="buy"><a href="javascript:$zopim.livechat.window.show();">Contact Us</a></li>
				</ul> -->
				<ul class="fifth">
		...
		<div class="container">
			<div class="next-page page3">
				<h3>Looking to <strong>migrate your forum</strong>, build a <strong>custom theme or plugin</strong>, <br />or <strong>customize a plan</strong> to suit your community's needs? <a href="javascript:$zopim.livechat.window.show();">Contact Us <span class="mobile-hide">&nbsp;<i class="fa fa-comments-o"></i></span></a>
			</div>
		</div>
	</div>